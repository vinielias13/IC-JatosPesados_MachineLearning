...
void CreatTreeBBBar(Int_t nev = 1000000, Int_t ndeb = 1)
{
    ...
    TFile *outfile = TFile::Open("BTagging.root", "RECREATE");
    
    //Criando TTree 
    TTree *tree = new TTree("tree", "BTagging Trees");
   ...
   // cout << "//---------------------------------------------------------------------------------------------------------//" <<endl;
        ...
        {   
            ...
            //cout<< "pt do jato = " << jet.pt() << " pt do constituinte = " << soma << " Ncosnt = " << nConstituent << " ijet " << ijet << endl;
